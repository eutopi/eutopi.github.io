                    ...
                    <div className="flex-column pub-wrapper">
                        ...
                        <div className="fun-text">
                            ...
                            <div className="flex-row pad-50">
                                    <img className="subpage-img-small" src={galaxy1}></img>
                                    <img className="subpage-img-small" src={galaxy2}></img>
                                    <img className="subpage-img-small" src={galaxy3}></img>
                            </div>
                            <div className="title">
                            ...
                            <div className="flex-row pad-50">
                                    <img className="subpage-img-small" src={tigger1}></img>
                                    <img className="subpage-img-small" src={tigger2}></img>
                                    <img className="subpage-img-small" src={tigger3}></img>
                            </div>
                            <div className="title">
                            ...
                            <div className="pad-50">
                                <img className="subpage-img" src={beach}></img>
                            </div>
                        </div>
                    </div>
                </div>
